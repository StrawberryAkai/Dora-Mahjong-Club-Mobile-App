-- Restore the canonical players API after recording migrations 002 and 003.
-- Fresh members-schema databases have no public.players table and need no repair.
DO $migration$
BEGIN
